        ...
        try {
            ...
            switch (options.getSubcommand()) {
                case "set": {
                    ...
                    Response.setColor(client.color).setDescription(`✅ Your AFK status has been updated to ${afkStatus}.`);
                ...
                case "return": {
                    ...
                    Response.setColor(client.color).setDescription(`❌ Your AFK status has been removed.`);
